        ...
        <view class="wrap">
            <view class="item">
                ...
                <view class="color-box">
                    <view class="color-item" :style="{ background: $u.getColor('primary') }">
                        <view class="color-title"> Primary </view>
                        <view class="color-value"> {{ $u.getColor('primary') }} </view>
                    </view>
                    <view class="color-item" :style="{ background: $u.getColor('primaryDark') }">
                        <view class="color-title"> Dark </view>
                        <view class="color-value"> {{ $u.getColor('primaryDark') }} </view>
                    </view>
                    <view class="color-item" :style="{ background: $u.getColor('primaryDisabled') }">
                        <view class="color-title"> Disabled </view>
                        <view class="color-value"> {{ $u.getColor('primaryDisabled') }} </view>
                    </view>
                    <view class="color-item" :style="{ background: $u.getColor('primaryLight') }">
                        <view class="color-title"> Light </view>
                        <view class="color-value"> {{ $u.getColor('primaryLight') }} </view>
                    </view>
                </view>
            </view>
            <view class="item">
