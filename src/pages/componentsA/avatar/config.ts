export const scenes = [
    { title: '个人中心', desc: '头像+昵称+等级+性别', demo: '头像卡片' },
    { title: '群成员列表', desc: '纯文字头像+自定义背景', demo: '群成员头像' }
];
export const faqs = [
    { q: '如何自定义头像内容？', a: '可通过text或src属性自定义文字或图片。' },
    { q: '如何显示等级和性别？', a: '设置showLevel和showSex为true即可。' }
];
export const tasks = [
    { title: '切换头像形状', desc: '体验不同形状的头像效果' },
    { title: '尝试显示/隐藏等级', desc: '观察等级标识变化' }
];
